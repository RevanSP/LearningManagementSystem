...
<head>
   ...
   <title>LKP Adicita | Komentar Pengguna</title>
   ...
   ?>
         <section class="edit-comment">
            ...
            <form action="" method="post">
               ...
               <textarea name="update_box" class="box" maxlength="1000" required placeholder="Silahkan Berikan Komentar Anda" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
               <div class="flex">
