...
<head>
   ...
   <title>LKP Adicita | Program 3 Bulan</title>
   ...
   <section class="contact">
      ...
      <div class="row">
         ...
         <form action="#" method="post">
            <h3>Program 3 Bulan</h3>
            <h1 class="ingfo">Program 3 bulan adalah program untuk pelatihan komputer selama 3 bulan yang memiliki 36x pertemuan dan 1x pertemuan hanya 2 jam.</h1><br>
            <h3>TATA TERTIB
               PESERTA DIDIK</h3>
