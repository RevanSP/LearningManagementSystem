...
<head>
   ...
   <title>LKP Adicita | Perbarui video</title>
   ...
   <section class="video-form">
      ...
      ?>
            <form action="" method="post" enctype="multipart/form-data">
               ...
               <input type="text" name="title" maxlength="100" required placeholder="Tulis Judul Video" class="box" value="<?= $fecth_videos['title']; ?>">
               <p>Perbarui Deskripsi <span>*</span></p>
               <textarea name="description" class="box" required placeholder="Tulis Deskripsi Video" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
               ...
               <select name="playlist" class="box">
                  ...
                  <?php
                     ...
                     echo '<option value="" disabled>Tidak Ada Playlists Yang Dibuat !</option>';
                  }
                  ?>
               </select>
