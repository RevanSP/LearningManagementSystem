...
if (isset($_POST['submit'])) {
   ...
   if ($thumb_size > 2000000) {
      $message[] = 'Ukuran Foto Ini Terlalu Besar !';
   } else {
      ...
      $message[] = 'Video Baru Telah Diupload !';
   }
}
?>
<!DOCTYPE html>
...
<head>
   ...
   <title>LKP Adicita | Dashboard</title>
...
<body>
   ...
   <section class="video-form">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <textarea name="description" class="box" required placeholder="Tulis Deskripsi Video" maxlength="1000" cols="30" rows="10"></textarea>
         ...
         <select name="playlist" class="box" required>
            ...
            <?php
               ...
               echo '<option value="" disabled>Tidak Ada Playlist Yang Dibuat</option>';
            }
            ?>
         </select>
         <p>Pilih Sampul Video <span>*</span></p>
