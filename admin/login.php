      ...
      <form action="" method="post" enctype="multipart/form-data" class="login">
         <center>
            <div class="login-brand">
               <img src="../images/LogoPerusahaan.png" alt="logo" width="69" class="shadow-light rounded-circle">
            </div>
         </center><br>
         ...
         <p class="link">Tidak Memiliki Akun ? <a href="register.php">Daftar</a></p>
