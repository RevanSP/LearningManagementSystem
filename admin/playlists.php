...
if (isset($_POST['delete'])) {
   ...
   if ($verify_playlist->rowCount() > 0) {
      ...
      $message[] = 'Playlist Siap Untuk Dihapus !';
   }
}
?>
<!DOCTYPE html>
...
<head>
   ...
   <title>LKP Adicita | Playlists</title>
...
<body>
   ...
   <section class="playlists">
      <h1 class="heading">Menambahkan Playlist</h1>
      <div class="box-container">
         <div class="box" style="text-align: center;">
            <h3 class="title" style="margin-bottom: .5rem;">Tambah Playlists Baru</h3>
         ...
         ?>
               <div class="box">
                  ...
                  <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Lihat Playlists</a>
               </div>
         <?php
            }
         } else {
