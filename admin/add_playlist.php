...
if (isset($_POST['submit'])) {
   ...
   $message[] = 'Playlist Baru Telah Ditambahkan !';
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
   ...
   <title>LKP Adicita | Tambah Playlist</title>
...
<body>
   ...
   <section class="playlist-form">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <input type="text" name="title" maxlength="100" required placeholder="Tulis Judul Playlist" class="box">
