...
if (isset($_POST['delete_video'])) {
   ...
   if ($verify_video->rowCount() > 0) {
      ...
      $message[] = 'Video Siap Untuk Dihapus !';
   }
}
?>
<!DOCTYPE html>
...
<head>
   ...
   <title>LKP Adicita | Detail Playlists</title>
...
<body>
   ...
   <section class="playlist-details">
      <h1 class="heading">Detail Playlists</h1>
      <?php
            ...
            <div class="row">
               ...
               <div class="details">
                  ...
                  <form action="" method="post" class="flex-btn">
                     ...
                     <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">Perbarui Playlists</a>
                     <input type="submit" value="delete playlist" class="delete-btn" onclick="return confirm('Hapus Playlist Ini ?');" name="delete">
                  </form>
               </div>
            </div>
      <?php
