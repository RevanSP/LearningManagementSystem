...
<head>
   ...
   <title>LKP Adicita | Konten</title>
   ...
   <section class="contents">
      ...
      <div class="box-container">
         <div class="box" style="text-align: center;">
            <h3 class="title" style="margin-bottom: .5rem;">Tambahkan Konten Baru</h3>
         ...
         ?>
               <div class="box">
                  ...
                  <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Lihat Komentar</a>
               </div>
         <?php
            }
         } else {
