...
<head>
   ...
   <title>LKP Adicita | Lihat Konten</title>
...
<body>
   ...
   <section class="view-content">
      ...
      <?php
         ...
         echo '<p class="empty">Belum Ada Komentar Yang Ditambahkan ! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Tambah Video</a></p>';
      }
      ?>
   </section>
