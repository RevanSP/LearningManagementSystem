...
<head>
   ...
   <title>LKP Adicita | Program 1 Bulan</title>
   ...
   <section class="contact">
      ...
      <div class="row">
         ...
         <form action="#" method="post">
            <h3>Program 1 Bulan</h3>
            <h1 class="ingfo">Program 1 bulan adalah program untuk pelatihan komputer selama 1 bulan yang memiliki 12x pertemuan dan 1x pertemuan hanya 2 jam.</h1><br>
            <h3>TATA TERTIB
               PESERTA DIDIK</h3>
