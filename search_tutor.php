...
<head>
   ...
   <title>LKP Adicita | Kursus</title>
...
<body>
   ...
   <section class="teachers">
      ...
      <h1 class="heading">Instruktur Ahli</h1>

      <form action="" method="post" class="search-tutor">
         <input type="text" name="search_tutor" maxlength="100" placeholder="Cari Instruktur ..." required>
      ...
      <div class="box-container">
         ...
         ?>
                  <div class="box">
                     ...
                     <p>Jumlah Videos : <span><?= $total_contents ?></span></p>
         ...
         <?php
            ...
            echo '<p class="empty">Silahkan Cari Yang Lain !</p>';
         }
         ?>
