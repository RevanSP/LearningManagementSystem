...
if (isset($_POST['submit'])) {
   ...
   if (!empty($email)) {
      ...
      if ($select_email->rowCount() > 0) {
         ...
         $message[] = 'Email Sudah Diperbarui !';
      }
   }
   ...
   if (!empty($image)) {
      if ($image_size > 2000000) {
         ...
         $message[] = 'Gambar Sudah Diperbarui !';
      }
   }
...
<head>
   ...
   <title>LKP Adicita | Perbarui Profil</title>
   ...
   <section class="form-container" style="min-height: calc(100vh - 19rem);">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <div class="flex">
            ...
            <div class="col">
               <p>Kata Sandi Lama</p>
               <input type="password" name="old_pass" placeholder="Masukan Kata Sandi Lama Anda" maxlength="50" class="box">
               <p>Kata Sandi Baru</p>
               <input type="password" name="new_pass" placeholder="Masukan Kata Sandi Baru Anda" maxlength="50" class="box">
               <p>Konfirmasi Kata Sandi</p>
               <input type="password" name="cpass" placeholder="Konfirmasi Kata Sandi Baru Anda" maxlength="50" class="box">
            </div>
         </div>
