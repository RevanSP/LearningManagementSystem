   ...
   if($user_id != ''){
      ...
      if($select_content->rowCount() > 0){
         ...
         if($select_comment->rowCount() > 0){
            $message[] = 'Komentar Siap Untuk Ditambahkan !';
         }else{
            ...
            $message[] = 'Komentar Baru Telah Ditambahkan !';
         }
...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Komentar Siap Untuk Dihapus !';
   }else{
...
<head>
   ...
   <title>LKP Adicita | Lihat Video</title>
...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="Silahkan Berikan Komentarmu" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">Batalkan Pengeditan</a>
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="Tulis Komentar Anda" maxlength="1000" cols="30" rows="10"></textarea>
   ...
   <div class="show-comments">
      ...
      <?php
         ...
         echo '<p class="empty">Tidak Ada Komentar Yang Ditambahkan !</p>';
      }
      ?>
      </div>
