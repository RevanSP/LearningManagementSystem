...
<head>
   ...
   <title>LKP Adicita | Instruktur</title>
...
<body>
   ...
   <section class="teachers">
      ...
      <h1 class="heading">Instruktur Professional</h1>

      <form action="search_tutor.php" method="post" class="search-tutor">
         <input type="text" name="search_tutor" maxlength="100" placeholder="Cari Tutorial ..." required>
      ...
      <div class="box-container">
         ...
         <div class="box offer">
            ...
            <p>Jadilah instruktur dan berikan perubahan positif dalam dunia pendidikan !</p><br><br><br><br><br><br>
         ...
         ?>
               <div class="box">
                  ...
                  <p>Jumlah Video : <span><?= $total_contents ?></span></p>
         ...
         <?php
            ...
            echo '<p class="empty">Tidak Ada Tutorial Yang Ditemukan !</p>';
         }
         ?>
